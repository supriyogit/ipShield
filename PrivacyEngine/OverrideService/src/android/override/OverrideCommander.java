...
public class OverrideCommander extends IOverrideCommander.Stub {
  ...
  private HashMap<String, HashSet<IOverrideCommandListener>> mListenerSets = new HashMap<String, HashSet<IOverrideCommandListener>>();
  ...
  private void relayCommandToListeners(String unusedPackageName, Bundle command) {
    for (String packageName : mListenerSets.keySet()) {
